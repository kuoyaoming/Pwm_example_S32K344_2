...
#else
    #error "EMIOS_1_CH_16 channel cannot be used by MCL driver. Channel locked by other driver!"
#endif
#ifndef EMIOS_1_CH_22_USED
    #define EMIOS_1_CH_22_USED
#else
    #error "EMIOS_1_CH_22 channel cannot be used by MCL driver. Channel locked by other driver!"
#endif
...
#define MCL_EMIOS_LOGIC_CH0     (uint16)((1U << 8U) + EMIOS_CH_0)
#define MCL_EMIOS_LOGIC_CH1     (uint16)((1U << 8U) + EMIOS_CH_8)
#define MCL_EMIOS_LOGIC_CH2     (uint16)((1U << 8U) + EMIOS_CH_16)
#define MCL_EMIOS_LOGIC_CH3     (uint16)((1U << 8U) + EMIOS_CH_22)
#define MCL_EMIOS_LOGIC_CH4     (uint16)((1U << 8U) + EMIOS_CH_23)
