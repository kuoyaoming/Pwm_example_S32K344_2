...
/**
* @brief          Symbolic name for the port DioPort_in.
*/
#define DioConf_DioPort_DioPort_in  ((uint8)0x03U)
/**
* @brief          Symbolic name for the channel DioChannel_Dig_Input_0.
*
*/
#define DioConf_DioChannel_DioChannel_Dig_Input_0  ((uint16)0x0030U)
/* ---------- DioPort_out ---------- */

/**
* @brief          Symbolic name for the port DioPort_out.
*/
#define DioConf_DioPort_DioPort_out  ((uint8)0x02U)
/**
* @brief          Symbolic name for the channel Digital_Output_LED_D78.
*
*/
#define DioConf_DioChannel_Digital_Output_LED_D78  ((uint16)0x002cU)
