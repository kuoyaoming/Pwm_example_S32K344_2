...
===============================================================================================*/
    ...
    /* Check if header file and FlexPwm_Ip_VS_0_PBcfg header file are of the same vendor */
#if (FLEXPWM_IP_CFG_VENDOR_ID != FLEXPWM_IP_VS_0_PB_CFG_VENDOR_ID)
    #error "Vendor IDs of FlexPwm_Ip_Cfg.h and FlexPwm_Ip_VS_0_PBcfg.h are different."
#endif

    /* Check if header file and FlexPwm_Ip_VS_0_PBcfg header file are of the same AUTOSAR version */
#if ((FLEXPWM_IP_CFG_AR_RELEASE_MAJOR_VERSION    != FLEXPWM_IP_VS_0_PB_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (FLEXPWM_IP_CFG_AR_RELEASE_MINOR_VERSION    != FLEXPWM_IP_VS_0_PB_CFG_AR_RELEASE_MINOR_VERSION) || \
     (FLEXPWM_IP_CFG_AR_RELEASE_REVISION_VERSION != FLEXPWM_IP_VS_0_PB_CFG_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR version numbers of FlexPwm_Ip_Cfg.h and FlexPwm_Ip_VS_0_PBcfg.h are different."
#endif

    /* Check if header file and FlexPwm_Ip_VS_0_PBcfg header file are of the same software version */
#if ((FLEXPWM_IP_CFG_SW_MAJOR_VERSION != FLEXPWM_IP_VS_0_PB_CFG_SW_MAJOR_VERSION) || \
     (FLEXPWM_IP_CFG_SW_MINOR_VERSION != FLEXPWM_IP_VS_0_PB_CFG_SW_MINOR_VERSION) || \
     (FLEXPWM_IP_CFG_SW_PATCH_VERSION != FLEXPWM_IP_VS_0_PB_CFG_SW_PATCH_VERSION))
    #error "Software version numbers of FlexPwm_Ip_Cfg.h and FlexPwm_Ip_VS_0_PBcfg.h are different."
#endif
